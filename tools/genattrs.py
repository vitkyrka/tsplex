...
class AttributeGen(object):
    ...
    def gen(self):
        ...
        transmap = dict([(c.name, c.sv.capitalize()) for c in self.chars])
        ...
        transmap.update({
            ...
            'motion_type_bending': 'Fingrarna böjs',
            'motion_type_circling': 'Förs i cirkel',
            'motion_type_curving': 'Förs i båge',
            'motion_type_playing': 'Fingrarna spelar',
            'motion_type_strewing': 'Fingrarna strör',
            'motion_type_waving': 'Fingrarna vinkar',
